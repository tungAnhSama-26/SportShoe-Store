...
BEGIN
    CREATE TABLE cham_cong (
        ...
        CONSTRAINT fk_cham_cong_nhan_vien FOREIGN KEY (nhan_vien_id) REFERENCES nhan_vien(id) ON DELETE NO ACTION,
        CONSTRAINT fk_cham_cong_lich_lam_viec FOREIGN KEY (lich_lam_viec_id) REFERENCES lich_lam_viec(id) ON DELETE NO ACTION,
