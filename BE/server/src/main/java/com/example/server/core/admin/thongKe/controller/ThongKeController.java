package com.example.server.core.admin.thongKe.controller;
...
import com.example.server.core.admin.thongKe.service.ThongKeService;
...
public class ThongKeController {
    ...
    public ResponseEntity<ApiResponse<ThongKeDashboardResponse>> layDashboardThongKe(
        ...
        ThongKeDashboardRequest request = new ThongKeDashboardRequest(
                fromDate,
                toDate,
                brandId,
                keyword,
