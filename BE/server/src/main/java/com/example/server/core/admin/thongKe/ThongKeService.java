...
public class ThongKeService {
    ...
    public ThongKeDashboardResponse layDuLieuThongKe(
            LocalDate tuNgay,
            LocalDate denNgay,
        ...
        BoLocThongKe boLoc = chuanHoaBoLoc(tuNgay, denNgay, thuongHieuId, keyword, kyThongKe);
        ...
        return new ThongKeDashboardResponse(
                ...
                taoThongKeSanPham(tatCaDongBanHang, tatCaSanPham)
        );
    }
