...
var stdin_default = defineConfig({
  ...
  server: {
    ...
    headers: {
      "Content-Security-Policy": "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' data: https://fonts.gstatic.com; img-src 'self' data: blob: http://localhost:8080 http://127.0.0.1:8080; media-src 'self' data: blob: http://localhost:8080 http://127.0.0.1:8080; connect-src 'self' ws: wss: http://localhost:8080 http://127.0.0.1:8080;",
