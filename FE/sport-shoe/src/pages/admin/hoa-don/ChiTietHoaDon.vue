...
<template>
  <div class="invoice-flat space-y-4 pb-10">
      ...
      <section class="grid items-stretch gap-3 xl:grid-cols-[1fr_1fr_0.95fr]">
        <Card class="flex h-full flex-col px-4 py-4 md:px-5 xl:col-span-2">
          ...
          <div class="relative mt-7 px-2 pt-2 flex justify-center">
            <div
              class="flex w-full items-start justify-around relative max-w-4xl"
            >
              <!-- Đường ziczac động -->
              <div
              ...
              >
                ...
                <div class="mt-1 min-h-[32px]">
                  <p
                    v-if="buoc.thoiGian"
                    class="text-[11px] leading-4 text-slate-400"
                  >
      ...
      <section class="grid gap-3 xl:grid-cols-[1fr_1fr_0.95fr]">
        ...
        <Card class="px-5 py-4">
          ...
          <div class="mt-4 space-y-4 text-sm">
            ...
            >
              ...
              <span
                class="max-w-[58%] text-right font-semibold text-slate-700"
                >{{ hoaDon.diaChi || "—" }}</span
              >
            </div>
            <div
        ...
        <div class="space-y-3">
          <Card class="px-5 py-4">
            ...
            <div
              v-if="hoaDon.lichSuThanhToan?.length"
          ...
          >
            <h2
              class="flex items-center gap-2 text-[15px] font-semibold text-[#B82220]"
            >
        ...
        <Card class="px-6 py-5">
          <template #header>
            <div>
              ...
              >
                ...
                <span
                  >Danh Sách Sản Phẩm ({{ hoaDon.sanPham?.length || 0 }})</span
                >
              </h2>
            </div>
          </template>
            ...
            >
              ...
              <label class="block">
                ...
                >
                  ...
                  <option
                    v-for="loai in danhSachLoaiSanPham"
                    :key="loai"
                    :value="loai"
                  >
                    {{ loai }}
          ...
          <div class="overflow-x-auto">
            <table class="w-full table-auto text-[15px]">
              <thead>
                <tr
                  class="bg-slate-100 text-left text-xs font-bold tracking-wide text-slate-950"
                >
      ...
      >
        ...
        >
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <h3
                class="text-lg font-extrabold uppercase tracking-wide text-slate-900"
              >
                Thanh toán COD
              </h3>
        ...
        <div class="min-h-0 flex-1 space-y-3 overflow-hidden px-5 py-4">
          ...
          >
            ...
            <div
              ...
              :class="
                formThanhToanCod.hinhThucThanhToan === 1 ? 'max-w-[420px]' : ''
              "
            >
              <label
                v-if="formThanhToanCod.hinhThucThanhToan === 1"
        ...
        <div
          class="shrink-0 border-t border-slate-100 bg-slate-50/90 px-5 py-4 sm:px-6"
        >
          <div
    ...
    >
      <div
        class="w-full max-w-[560px] overflow-hidden rounded-[24px] bg-white shadow-2xl"
      >
        <div class="bg-amber-50 px-6 py-5">
          <div class="flex items-start justify-between gap-4">
            <div class="flex items-start gap-3">
              ...
              <div>
                <h3
                  class="text-lg font-extrabold uppercase tracking-wide text-slate-800"
                >
                  Xác nhận hoàn tiền
                </h3>
                <p class="mt-1 text-sm text-slate-500">
        ...
        <div class="space-y-4 px-6 py-5">
          ...
          >
            ...
            <span class="text-lg font-extrabold text-amber-600">{{
              dinhDangTien(tongTienHoan)
            }}</span>
          </div>

          <label class="block space-y-2">
            <span class="text-sm font-bold text-slate-600"
              >Phương thức hoàn</span
            >
            <select
          ...
          <div v-if="formHoanTien.hinhThucHoanTien === 2" class="space-y-4">
            <div class="space-y-2">
              <span class="text-sm font-bold text-slate-600"
                >Tài khoản ngân hàng nhận tiền của khách</span
              >
              ...
              <div class="text-center space-y-0.5">
                ...
                <p class="text-xs font-semibold text-slate-500">
                  STK: {{ taiKhoanNganHangChon.soTaiKhoan }} ({{
                    taiKhoanNganHangChon.tenNganHang
                  }})
                </p>
              </div>
            </div>
      ...
      >
        <div class="p-6">
          <div class="flex items-start gap-4">
            <div
              class="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-rose-50 text-[#B82220]"
            >
              <TriangleAlert class="h-6 w-6" />
            </div>
            <div>
              <h3 class="text-[19px] font-bold text-slate-800">
                Xác Nhận Hủy Đơn Hàng?
              </h3>
              <p class="mt-2 text-sm leading-6 text-slate-500">
                Bạn có chắc chắn muốn xác nhận hủy đơn hàng này không? Sau khi
                xác nhận, đơn hàng sẽ chuyển sang trạng thái đã hủy.
              </p>
            </div>
          </div>
      ...
      >
        ...
        <div class="max-h-[70vh] overflow-y-auto px-6 py-8">
          ...
          <div v-else class="relative pl-8">
            <!-- Trục timeline đỏ -->
            <div
              class="absolute bottom-0 left-[3.5px] top-0 w-[1.5px] bg-[#B82220]/20"
            ></div>
            ...
            <div class="space-y-6">
              <div v-for="log in lichSuRutGon" :key="log.id" class="relative">
                ...
                >
                  ...
                  <p
                    v-if="log.ghiChu"
                    class="mt-2 text-[13px] text-slate-500 italic"
                  >
                    {{ log.ghiChu }}
                  </p>
                </div>
    ...
    >
      <div
        class="w-full max-w-4xl overflow-hidden rounded-[32px] bg-white shadow-2xl"
      >
    ...
    >
      <div
        class="w-full max-w-[600px] overflow-hidden rounded-[16px] bg-white shadow-2xl"
      >
        <div
          class="flex items-center justify-between border-b border-slate-100 px-6 py-4"
        >
        ...
        <div class="p-6">
          <div v-if="tabHienTai === 'donHang'" class="space-y-4">
            <div class="grid grid-cols-2 gap-4">
              <div>
                <label
                  class="mb-1.5 block text-[13px] font-medium text-slate-600"
                  >Mã đơn hàng</label
                >
                <input
                  type="text"
            ...
            <div>
              ...
              >
                <template
                  v-for="(st, index) in danhSachTrangThaiHienThi"
                  :key="st.key"
                >
                  <option
