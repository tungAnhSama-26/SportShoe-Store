...
async function loadData(page = 0) {
  ...
  try {
    ...
    showToast(getDisplayErrorMessage(e, 'Không thể tải danh sách cổ giày'), 'error')
  } finally {
    loading.value = false
  }
}
...
async function handleToggleStatus(item) {
  ...
  try {
    ...
    showToast(getDisplayErrorMessage(e, 'Không thể cập nhật trạng thái cổ giày'), 'error')
  } finally {
