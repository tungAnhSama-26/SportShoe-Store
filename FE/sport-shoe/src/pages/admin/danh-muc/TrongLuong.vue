...
function generateCode() {
  return generateWeightAttributeCode(form.giaTri, codeSeed.value)
}
...
function clearForm() {
  ...
  Object.assign(form, { ma: '', giaTri: null, moTa: '' })
...
function openEdit(item) {
  clearForm()
  Object.assign(form, { ma: item.ma, giaTri: item.giaTri, moTa: item.moTa || '' })
          ...
          <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
              <h2 class="text-lg font-semibold text-gray-800">
                {{ modalMode === 'add' ? 'Thêm trọng lượng' : modalMode === 'edit' ? 'Cập nhật trọng lượng' : 'Chi tiết trọng lượng' }}
              </h2>
